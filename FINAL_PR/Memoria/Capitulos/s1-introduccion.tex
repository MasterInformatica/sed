...
sobre una arquitectura distribuida formada por una FPGA~\cite{Spartan3}, y
...
FPGA. \rev{La puntuación del juego también es mostrada por los \textit{display}
...
la sección~\ref{21:sec:Disenyo} se muestra el modelado realizado por el
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{images/Todo.pdf}
